...
def less(gdl_file):
    if function_dict["less"] != 0:
        return
    function_dict["less"] = 1
...
def distinct_cells(gdl_file):
    if function_dict["distinct_cells"] != 0:
        return
    function_dict["distinct_cells"] = 1
...
def adjacent_cells(gdl_file):
    if function_dict["adjacent_cells"] != 0:
        return
    function_dict["adjacent_cells"] = 1
